...
const features = [
  {
    ...
    icon: <Image src={`${basePath}/colorcard.png`} alt="ColorCard" width={48} height={48} className="object-contain rounded-xl" />,
    color: 'bg-[#C1D82F]',
  ...
  },
  {
    ...
    icon: <Image src={`${basePath}/iframe.png`} alt="iFrame" width={48} height={48} className="object-contain rounded-xl" />,
    color: 'bg-[#87CEEB]',
  ...
  },
  {
    ...
    icon: <Image src={`${basePath}/progress.png`} alt="Progress" width={48} height={48} className="object-contain rounded-xl" />,
    color: 'bg-[#FFD700]',
  ...
  },
  {
    ...
    icon: <Image src={`${basePath}/menuai.png`} alt="Menu AI" width={48} height={48} className="object-contain rounded-xl" />,
    color: 'bg-[#1B4B8C]',
